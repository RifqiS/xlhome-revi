...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 navbar-dark cnav text-white border-bottom shadow-sm">
    <h5 class="my-0 mr-md-auto font-weight-normal"><a href="<?= $base_url; ?>"><img src="<?= $base_url; ?>assets/img/FA•XL Home Logo Only(2019)-01.png" alt="" style="height: 70px; weight: 100px;"></a></h5>
